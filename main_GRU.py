...
import pandas as pd
from models import GRU as gru_model
...
def train_model_GRU(train_data, model = False):
    ...
    if not model:
        model = gru_model.neural_network_GRU(time_steps,features)
...
model = train_model_GRU(training_data)
# model.save('model_GRU_1')